...
const NAV = [
  ...
  { to: "/finance-loop", label: "Finance Loop", scope: "finance_loop" },
  ...
  { to: "/people-loop", label: "People Loop", scope: "people_loop" },
  { to: "/runtime", label: "Adaptive Runtime", scope: "runtime" },
  { to: "/learning", label: "Learning", scope: "learning" },
